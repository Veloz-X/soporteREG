...
class UserController extends Controller
{
    ...
    {
        $this->authorize('manage_customers', User::class);
        return view('dashboard.customers.index');
    }

    public function employees()
    {
        $this->authorize('manage_employees', User::class);
    ...
    {   
        ...
        return view('dashboard.customers.profile', ['user' => $user]);
    }

    public function employeeProfile(Request $request, $id)
    {   
        $user = User::role( ['admin','agent','non-restricted_agent'] )->findOrFail($id);
        $this->authorize('view', $user);
        return view('dashboard.employees.profile', ['user' => $user]);
    }
    ...
    public function list()
    {
        ...
        $user = User::role(['admin','agent','non-restricted_agent'] )->orderBy('id', 'desc')->paginate(500);
    ...
    {
        $this->authorize('viewAny', User::class);
        $user = User::role(['customer'])->orderBy('id', 'desc')->paginate(500);
        return UserResource::collection($user);
    }
