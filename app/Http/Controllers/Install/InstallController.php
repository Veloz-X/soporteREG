...
{
    private $APIUrl = "https://ticky.psserver.xyz/verify";
    ...
    public function folderPermissions(Request $request)
    {
        ...
        return view('install.folderPermissions', ['folders' => $folders]);
    }
    ...
    public function productLicense(Request $request)
    {
        ...
        return view('install.productLicense');
    }
    ...
    public function database(Request $request)
    {
        ...
        if ($request->isMethod('post')){
            ...
            if(DB::select('SHOW TABLES')){
                return redirect()->back()->withInput()->withErrors("Database is not empty, please use an empty database");
            }
            ...
            \App\Category::create(['name' => 'default category', 'is_active' => 1]);
