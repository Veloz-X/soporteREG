...
<div class="container page-profile">
  ...
  <div class="row">
      ...
      <div class="col-lg-12">
      <input class="btn btn-primary float-right m-3" type="submit" value="<?php echo e(__('Save')); ?>">
      </div>
  </div>
  </form>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.base', ['page' => 'profile', 'pageTitle' => __('Profile')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fastbrao/soporte.recargaloya.com/resources/views/dashboard/profile/index.blade.php ENDPATH**/ ?>