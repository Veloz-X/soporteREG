    ...
    public static function generateFrontEndCSS()
    {
        ...
        $css = "
            #intro .overlay {
                ...
                background-image: url(".setting('frontend_hero_bg_image', '../../../assets/img/pattern.svg').");
            }
            ...
            .bg-login-image {
                background-image: url(".setting('frontend_auth_bg_image', '../../img/auth.svg').");
            }

        ";

        file_put_contents(public_path('assets/frontend/css/style.css'), self::optimizeCSS($css));
