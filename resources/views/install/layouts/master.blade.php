                    ...
                    <div class="card mt-5 mb-5 installer-card">
                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    @isset($next)
                                        <a href="{{$next}}" class="btn float-right btn-sm btn-outline-primary">Next</a>
                                    @endisset
                                    @isset($finish)
                                        <a href="{{$finish}}" class="btn float-right btn-sm btn-outline-primary">Finish</a>
                                    @endisset
                                    @isset($action)
                        ...
                        <div class="card-footer">
                            ...
                            <div class="progress">
                            <div class="progress-bar progress-bar-striped @if($step == $total_steps) bg-success @else bg-success  @endif" role="progressbar" style="width: {{number_format( ($step/$total_steps) * 100, 2 )}}%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>  
                </div>
