@extends('dashboard.base', ['page' => 'notifications', 'pageTitle' => __('notifications.notifications')])
...
<div class="mb-2">
    ...
    <a class="d-flex align-items-center p-3 text-decoration-none border-bottom" href="{{ @$notification->data['link'] }}">
        <div class="mr-2">
            <i class="fas fa-2x fa-{{ @$notification->data['icon'] }} text-{{@$notification->data['color']}}"></i>
        </div>
        <div>
