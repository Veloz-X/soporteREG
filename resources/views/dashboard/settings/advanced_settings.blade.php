@extends('dashboard.base', ['page' => 'settings', 'pageTitle' => __('Advanced settings')])
    ...
    <div class="card-body p-0 m-0">
      <table class="table table-striped table-sm">
        ...
        {{-- <tr>
            ...
            <td><span class="badge badge-secondary">{{ini_get("max_execution_time")}} seconds</span></td>
            <td>
        ...
        <tr>
            ...
            <td><span class="badge badge-secondary">{{ini_get("max_input_time")}} Seconds</span></td>
            <td>
        ...
        <tr>
            ...
            <td><span class="badge badge-secondary">{{ini_get("max_input_vars")}}</span></td>
            <td>
        ...
        <tr>
            <td>Memory limit</td>
            <td><span class="badge badge-secondary">{{ini_get("memory_limit")}}</span></td>
            <td>
        ...
        <tr>
            <td>Post max size</td>
            <td><span class="badge badge-secondary">{{ini_get("post_max_size")}}</span></td>
            <td>
        ...
        <tr>
            ...
            <td><span class="badge badge-secondary">{{ini_get("upload_max_filesize")}}</span></td>
            <td>
        ...
        <tr>
          <td>Zip extension</td>
          <td><span class="badge badge-secondary">{{ extension_loaded('zip') ? __('Enabled') : __("Disabled / not installed") }}</span></td>
          <td>
